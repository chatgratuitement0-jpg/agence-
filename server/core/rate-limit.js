...
export const integrationLimiters=Object.freeze({ai:new RateLimiter({max:30}),whatsapp:new RateLimiter({max:30}),sms:new RateLimiter({max:20}),webhook:new RateLimiter({max:120})});
